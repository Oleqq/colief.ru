...
$('.faq__item-question').on('click',function () {
    ...
    $(this).parent().find('.faq__item-answer').slideToggle();
});
    ...
    var sliderAdvantages = new Swiper(".advantages-swiper", {
        navigation: {
    ...
    ScrollReveal().reveal('.welcome__img, .about__img, .symptoms__img, .how__img, .why__table, .advantages__img, .title-wrap__img, .buy__block-img, .faq__img', {
        scale: .8,
        duration: 1300,
        useDelay: 'onload',
        interval: 80,
...
//ScrollReveal bottom
    ScrollReveal().reveal('.welcome__info, .symptoms__video-wrap, .health__wrap', {
        scale: 1,
        duration: 1500,
        useDelay: 'onload',
        origin: 'bottom',
    ...
    $(".wrapper").on("click",".menu a", function (event) {
        event.preventDefault();
    ...
    if (document.querySelector('.top-btn')) {
        ...
        if (window.innerWidth < 992 && !changed) {
            $('.wrap-nav nav').after($('.top-btn'));
            changed = true;
        } else if (window.innerWidth > 991 && changed) {
            $('.header__wrap').prepend($('.top-btn'));
            changed = false;
        }
    ...
    if (document.querySelector('.welcome__img')) {
        let changed = false;
        if (window.innerWidth < 768 && !changed) {
            $('.welcome__text h1').after($('.welcome__img'));
            changed = true;
        } else if (window.innerWidth > 767 && changed) {
            $('.welcome').prepend($('.welcome__img'));
            changed = false;
        }
        $( window ).resize(function() {
            if (window.innerWidth < 768 && !changed) {
    ...
    if (document.querySelector('.about__img')) {
        let changed = false;
        if (window.innerWidth < 768 && !changed) {
            $('.about__wrap').prepend($('.about__img'));
            changed = true;
        } else if (window.innerWidth > 767 && changed) {
            $('.about__block').prepend($('.about__img'));
            changed = false;
        }
        $( window ).resize(function() {
            if (window.innerWidth < 768 && !changed) {
    ...
    if (document.querySelector('.how-button')) {
        let changed = false;
        if (window.innerWidth < 768 && !changed) {
            $('.how__benefits-second').after($('.how-button'));
            changed = true;
        } else if (window.innerWidth > 767 && changed) {
            $('.how__item-first .link-download').after($('.how-button'));
            changed = false;
        }
        $( window ).resize(function() {
            if (window.innerWidth < 768 && !changed) {
